...
const Account = () => {
  ...
  const [pictures, setPictures] = useState([
    "https://sambayan-1.s3.ap-south-1.amazonaws.com/logo.png",
  ]);
  ...
  const getProfile = async () => {
    try {
      ...
      const response = await getRequest(`/api/secure/user/profile`, token);
      setProfile(response.result.data.user);
    } catch (error) {
  ...
  const getProfileImage = async () => {
    try {
      ...
      console.log(
        ...
        response.result.data.user.profileImage
      );
                ...
                <div className="col-lg-4 col-md-4 col-12">
                  ...
                  >
                    <div className="d-flex">
                      ...
                      <p className="p_3">Approver Dashboard</p>
                    </div>
                  </button>
                ...
                <div className="col-lg-4 col-md-4 col-12">
                  ...
                  >
                    <div className="d-flex">
                      ...
                      <p className="p_3">Manager Dashboard</p>
                    </div>
                  </button>
                  <hr className="mb-1 mt-3" />
                </div>
              ...
              <div className="col-lg-4 col-md-4 col-12">
                ...
                >
                  <div className="d-flex">
                    ...
                    <p className="p_3">My Joined Events</p>
                  </div>
                </button>
                <hr className="mb-1 mt-3" />
              </div>
              ...
              <div className="col-lg-4 col-md-4 col-12">
                ...
                >
                  <div className="d-flex">
                    ...
                    <p className="p_3">Polls And Positions</p>
                  </div>
                </button>
                <hr className="mb-1 mt-3" />
              </div>
              ...
              <div className="col-lg-4 col-md-4 col-12">
                ...
                >
                  <div className="d-flex">
                    ...
                    <p className="p_3">Edit Profile</p>
                  </div>
                </button>
                <hr className="mb-1 mt-3" />
              </div>
              ...
              <div className="col-lg-4 col-md-4 col-12">
                ...
                >
                  <div className="d-flex">
                    ...
                    <p className="p_3">Change Password</p>
                  </div>
                </button>
                <hr className="mb-1 mt-3" />
              </div>
