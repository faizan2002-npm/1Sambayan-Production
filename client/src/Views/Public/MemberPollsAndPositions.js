...
export const MemberPollsAndPositions = () => {
  ...
  const getPolls = async () => {
    try {
      ...
      const response = await getRequest(`/api/secure/poll/poll-list`, token);
        ...
        <section className="py-5 mt-5">
          <Container>
            ...
            {pollsData?.length ? (
              ...
              <>
                <p className="text-center">There are no active polls.</p>
              </>
            )}
          </Container>
        </section>
        <section className="py-5">
          <Container>
            ...
            {positionsData?.length ? (
              ...
              <>
                <p className="text-center">There are no active positions.</p>
              </>
            )}
          </Container>
        </section>
