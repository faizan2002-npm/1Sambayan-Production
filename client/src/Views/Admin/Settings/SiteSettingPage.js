...
class SiteSettingPage extends React.Component {
    ...
    fetchUserDetails = async () => {
        ...
        this.setState({
            ...
            siteLogo: "https://1sambayan-env.eba-5wmwf5mk.us-east-1.elasticbeanstalk.com/views/uploads/" + response.result.data.site[0].logo,
            siteVideo: "https://1sambayan-env.eba-5wmwf5mk.us-east-1.elasticbeanstalk.com/views/uploads/" + response.result.data.site[0].video,
