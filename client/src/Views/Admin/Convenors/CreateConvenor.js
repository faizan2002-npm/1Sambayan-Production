...
class CreateConvenor extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            title: '',
    ...
    addSliderHandler = async (e) => {
        ...
        try {
            ...
            if (response.result.status === 200) {
                ...
                window.location.assign('/admin/ListConvenors');
