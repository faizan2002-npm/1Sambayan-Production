        ...
        {siteSetting.logo ? (
          <NavbarBrand className="pt-0" {...navbarBrandProps}>
            <img
              ...
              src={"https://1sambayan-env.eba-5wmwf5mk.us-east-1.elasticbeanstalk.com/views/uploads/" + siteSetting.logo}
            />
          </NavbarBrand>
        ) : null}
        {/* User */}
            ...
            <DropdownToggle nav>
              <Media className="align-items-center">
                <span className="avatar avatar-sm rounded-circle">
                  <img
                    alt="..."
                    src={"https://1sambayan-env.eba-5wmwf5mk.us-east-1.elasticbeanstalk.com/views/uploads/" + profileImage}
                  />
                </span>
              </Media>
            </DropdownToggle>
